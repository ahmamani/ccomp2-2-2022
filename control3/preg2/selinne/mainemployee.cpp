...
int main() {
 ...
 new SalariedEmployee("John", "Smith", "111-11-1111", 800,50), 
 new CommissionEmployee("Sue", "Jones", "333-33-3333", 10000, .06,10),
 new BasePlusCommissionEmployee( "Bob", "Lewis", "444-44-4444", 5000, .04, 300,14)};
